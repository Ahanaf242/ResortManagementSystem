...
public class BookingManager {
    ...
    public boolean addBooking(Booking booking) {
        ...
        Booking existingBooking = findBookingByRoom(
    ...
    public Booking findBookingByCustomerPhone(String phone) {
        ...
        for (Booking booking : bookingList) {
            if (booking.getCustomer().getPhone().equals(phone.trim())) {
                return booking;
            }
        }
        return null;
    ...
    public boolean updateBooking(int roomNumber, int days,
        ...
        booking.updateStay(days, checkInDate, checkOutDate);
        return true;
    }
    ...
    public boolean removeBookingByRoom(int roomNumber) {
        Booking booking = findBookingByRoom(roomNumber);
        return booking != null && removeBooking(booking);
    }
